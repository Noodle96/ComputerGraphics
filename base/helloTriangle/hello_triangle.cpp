...
int main(){
    ...
    //BUILD AND COMPILE OUR SHADER PROGRAMA
    int success; char *infoLog;
    unsigned int vertexShader;
    build_compile_vertexShader(success,infoLog, vertexShader);

    unsigned int fragmentShader;
    build_compile_fragmentShader(success, infoLog, fragmentShader);
    
    unsigned int shaderProgram;
    build_compile_linkShader(success, infoLog, shaderProgram, vertexShader, fragmentShader);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        // ------
        glClearColor(5.0/255,250.0/255,180.0/255,1.0f);
